...
<nav x-data="{ open: false }"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="{{ route('home') }}"
                    class="text-white hover:text-green-400 dark:hover:text-green-600">Beranda</a>
                <a href="#fitur" class="text-white hover:text-green-400 dark:hover:text-green-600 ">Fitur Kami</a>
                <a href="#profil-mc" class="text-white hover:text-green-400 dark:hover:text-green-600 ">Profil MC</a>
                <a href="#kontak" class="text-white hover:text-green-400 dark:hover:text-green-600 ">Kontak</a>

                @guest
                    <a href="{{ route('login') }}"
                        class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-full transition duration-300">Login</a>
                    <a href="{{ route('register') }}"
                        class="bg-transparent border border-green-500 text-green-500 hover:bg-green-500 hover:text-white font-semibold py-2 px-4 rounded-full transition duration-300 ml-2">Daftar</a>
                @endguest
                @auth
                    @php
            ...
            <div class="md:hidden flex items-center">
                <button @click="open = !open"
                    class="text-white hover:text-green-400 dark:hover:text-green-600 focus:outline-none">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        <nav class="space-y-2 text-gray-400 dark:text-gray-700"> {{-- Kurangi space-y --}}
            <a href="{{ route('home') }}"
                class="block px-4 py-2 hover:bg-indigo-600 text-white dark:text-gray-700 dark:hover:text-white rounded">Beranda</a>
            <a href="#fitur"
                class="block px-4 py-2 hover:bg-indigo-600 text-white dark:text-gray-700 dark:hover:text-white rounded">Fitur
                Kami</a>
            <a href="#profil-mc"
                class="block px-4 py-2 hover:bg-indigo-600 text-white dark:text-gray-700 dark:hover:text-white rounded">Profil
                MC</a>
            <a href="#kontak"
                class="block px-4 py-2 hover:bg-indigo-600 text-white dark:text-gray-700 dark:hover:text-white rounded">Kontak</a>
